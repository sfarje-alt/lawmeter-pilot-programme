...
export const peruLegislationData: PeruLegislationItem[] = [
  ...
  {
    id: "pe-ds-015-2024-produce",
    identificador: "Decreto Supremo N° 015-2024-PRODUCE",
    titulo: "Reglamento de Seguridad de Electrodomésticos de Cocina",
    resumen: "Establece requisitos técnicos de seguridad para hervidores eléctricos, cafeteras y otros electrodomésticos de cocina comercializados en el Perú.",
    puntosClave: [
      "Certificación obligatoria UL/IEC para productos de calentamiento",
      "Sistemas de apagado automático requeridos",
      "Etiquetado de seguridad en español obligatorio"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "decreto-supremo",
    esVinculante: true,
    autoridadEmisora: "PRODUCE - Ministerio de la Producción",
    autoridadFiscalizadora: "INDECOPI",
    autoridadesCompetentes: ["PRODUCE", "INDECOPI"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(3),
    fuentePublicacion: "El Peruano",
    fechaEntradaVigencia: diasAtras(3),
    nivelRiesgo: "alto",
    puntajeRiesgo: 85,
    categoria: "Seguridad de Producto",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Certificación de seguridad", "Etiquetado", "Pruebas de producto"],
    areasImpacto: ["Producción", "Importación", "Comercialización"],
    resumenIA: {
      queCambia: "Impone certificación obligatoria para hervidores y cafeteras. Sistemas de apagado automático requeridos. Etiquetado en español.",
      afectados: "Fabricantes e importadores de electrodomésticos de cocina. INDECOPI fiscalizará en puntos de venta.",
      fechaClave: `Vigente desde ${diasAtras(3)}. Cumplimiento inmediato requerido.`,
      explicacionRiesgo: "Alto impacto por aplicación inmediata. Productos sin certificación no pueden comercializarse.",
      actoresClave: ["PRODUCE", "INDECOPI", "Laboratorios acreditados"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-ds-015-2024-produce"
  },
  {
    id: "pe-rm-089-2024-mtc",
    identificador: "Resolución Ministerial N° 089-2024-MTC/01.03",
    titulo: "Actualización de Límites de Emisión RF para Dispositivos IoT",
    resumen: "Actualiza los límites de emisión de radiofrecuencia para dispositivos conectados del consumidor incluyendo electrodomésticos inteligentes.",
    puntosClave: [
      "Nuevos límites para banda 6 GHz (WiFi 6E)",
      "Requisitos de certificación homologación MTC",
    ...
    esVinculante: true,
    autoridadEmisora: "MTC - Ministerio de Transportes y Comunicaciones",
    autoridadFiscalizadora: "OSIPTEL",
    autoridadesCompetentes: ["MTC", "OSIPTEL"],
    estado: "en-tramite",
    estadoGenerico: "pipeline",
    indiceEtapaActual: 2,
    fechaPublicacion: diasAtras(5),
    fuentePublicacion: "El Peruano",
    fechaLimiteCumplimiento: diasAdelante(180),
    nivelRiesgo: "alto",
    puntajeRiesgo: 78,
    categoria: "Telecomunicaciones",
    sector: "IoT/Electrodomésticos Inteligentes",
    obligacionesAfectadas: ["Homologación RF", "Certificación EMC", "Documentación técnica"],
    areasImpacto: ["Desarrollo de producto", "Importación", "Certificación"],
    resumenIA: {
      queCambia: "Nuevos requisitos RF para WiFi 6E. Homologación MTC obligatoria para electrodomésticos conectados.",
      afectados: "Fabricantes de hervidores y cafeteras con WiFi. OSIPTEL fiscalizará cumplimiento.",
      fechaClave: `Publicado ${diasAtras(5)}. Cumplimiento en 180 días.`,
      explicacionRiesgo: "Impacto en productos con conectividad WiFi 6E. Requiere recertificación.",
      actoresClave: ["MTC", "OSIPTEL", "Laboratorios homologados"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-rm-089-2024-mtc"
  },
  // Items 8-14 days ago
  {
    id: "pe-or-245-2024-grl",
    identificador: "Ordenanza Regional N° 245-2024-GRL",
    titulo: "Promoción del Reciclaje de RAEE en la Región Loreto",
    resumen: "Establece incentivos tributarios para empresas que implementen programas de reciclaje de residuos de aparatos eléctricos y electrónicos.",
    puntosClave: [
      "Reducción de 10% en arbitrios municipales por programa RAEE",
      "Puntos de acopio obligatorios en centros comerciales",
      "Campañas educativas semestrales"
    ],
    pais: "PE",
    nivel: "regional",
    departamento: "LOR",
    tipoNorma: "ordenanza-regional",
    esVinculante: true,
    autoridadEmisora: "Gobierno Regional de Loreto",
    autoridadFiscalizadora: "OEFA - Loreto",
    autoridadesCompetentes: ["GRL", "OEFA Loreto"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(10),
    fuentePublicacion: "El Peruano (Normas Regionales)",
    fechaEntradaVigencia: diasAtras(10),
    nivelRiesgo: "medio",
    puntajeRiesgo: 52,
    categoria: "Medio Ambiente",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Programa RAEE", "Puntos de acopio", "Campañas educativas"],
    areasImpacto: ["Responsabilidad extendida", "Distribución", "Marketing"],
    resumenIA: {
      queCambia: "Incentivos tributarios para reciclaje RAEE en Loreto. Puntos de acopio en centros comerciales.",
      afectados: "Importadores y distribuidores con presencia en Loreto. Beneficio de reducción de arbitrios.",
      fechaClave: `Vigente desde ${diasAtras(10)}. Incentivos aplicables desde Q1 2025.`,
      explicacionRiesgo: "Riesgo bajo - oportunidad de beneficio tributario por cumplimiento.",
      actoresClave: ["GRL", "OEFA Loreto", "Municipalidades"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-or-245-2024-grl"
  },
  {
    id: "pe-dl-1589-2024",
    identificador: "Decreto Legislativo N° 1589",
    titulo: "Fortalecimiento del Sistema Nacional de Protección al Consumidor",
    resumen: "Fortalece las facultades de INDECOPI para sancionar prácticas comerciales desleales y productos defectuosos.",
    puntosClave: [
      "Incremento de multas hasta 500 UIT",
      "Facultad de recall obligatorio para productos peligrosos",
      "Responsabilidad solidaria de importadores"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "decreto-legislativo",
    ...
    autoridadEmisora: "Poder Ejecutivo (delegación del Congreso)",
    autoridadFiscalizadora: "INDECOPI",
    autoridadesCompetentes: ["INDECOPI", "PCM"],
    estado: "en-tramite",
    estadoGenerico: "pipeline",
    indiceEtapaActual: 3,
    fechaPublicacion: diasAtras(12),
    fuentePublicacion: "El Peruano",
    fechaLimiteCumplimiento: diasAdelante(90),
    nivelRiesgo: "alto",
    puntajeRiesgo: 88,
    categoria: "Protección al Consumidor",
    sector: "Comercio General",
    obligacionesAfectadas: ["Garantías de producto", "Respuesta a reclamos", "Información al consumidor"],
    areasImpacto: ["Servicio al cliente", "Legal", "Calidad"],
    resumenIA: {
      queCambia: "Aumenta sanciones INDECOPI. Recall obligatorio para productos peligrosos. Importadores responden solidariamente.",
      afectados: "Todos los comercializadores de electrodomésticos. Mayor exposición a sanciones.",
      fechaClave: `Proyecto publicado ${diasAtras(12)}. Pendiente promulgación.`,
      explicacionRiesgo: "Alto impacto por incremento de sanciones y responsabilidad solidaria de importadores.",
      actoresClave: ["INDECOPI", "PCM", "Asociaciones de consumidores"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-dl-1589-2024"
  },
  // Items 15-30 days ago
  {
    id: "pe-ntp-350-072-2024",
    identificador: "NTP 350.072:2024",
    titulo: "Seguridad de Aparatos Electrodomésticos - Cafeteras Eléctricas",
    resumen: "Norma técnica que establece requisitos de seguridad específicos para máquinas de café eléctricas para uso doméstico.",
    puntosClave: [
      "Requisitos de aislamiento eléctrico específicos para cafeteras",
      "Límites de temperatura de superficies accesibles",
      "Pruebas de derrame y sobrecalentamiento"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "ntp",
    esVinculante: false,
    autoridadEmisora: "INACAL - Instituto Nacional de Calidad",
    autoridadFiscalizadora: "N/A (norma voluntaria, salvo referencia en reglamento)",
    autoridadesCompetentes: ["INACAL"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(18),
    fuentePublicacion: "Catálogo INACAL",
    fechaEntradaVigencia: diasAtras(18),
    nivelRiesgo: "medio",
    puntajeRiesgo: 65,
    categoria: "Seguridad de Producto",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Cumplimiento voluntario", "Certificación opcional"],
    areasImpacto: ["Diseño de producto", "Calidad", "Marketing"],
    resumenIA: {
      queCambia: "Nueva NTP para cafeteras eléctricas. Define requisitos de seguridad específicos para el mercado peruano.",
      afectados: "Fabricantes de cafeteras. Cumplimiento voluntario pero recomendado para diferenciación.",
      fechaClave: `Vigente desde ${diasAtras(18)}. De aplicación voluntaria.`,
      calificadorVoluntariedad: "De aplicación voluntaria salvo referencia en un reglamento técnico.",
      explicacionRiesgo: "Riesgo medio - cumplimiento recomendado para competitividad y reducción de responsabilidad.",
      actoresClave: ["INACAL", "Laboratorios acreditados"]
    },
    linkFuente: "https://catalogo.inacal.gob.pe/placeholder-ntp-350-072"
  },
  {
    id: "pe-ds-018-2024-minem",
    identificador: "Decreto Supremo N° 018-2024-MINEM",
    titulo: "Reglamento de Eficiencia Energética para Electrodomésticos",
    resumen: "Establece requisitos de eficiencia energética y etiquetado para electrodomésticos de uso doméstico.",
    puntosClave: [
      "Etiquetado de eficiencia energética obligatorio (A-G)",
      "Estándares mínimos de rendimiento (MEPS)",
      "Registro de productos en base de datos MINEM"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "decreto-supremo",
    esVinculante: true,
    autoridadEmisora: "MINEM - Ministerio de Energía y Minas",
    autoridadFiscalizadora: "OSINERGMIN",
    autoridadesCompetentes: ["MINEM", "OSINERGMIN"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(22),
    fuentePublicacion: "El Peruano",
    fechaEntradaVigencia: diasAtras(22),
    fechaLimiteCumplimiento: diasAdelante(365),
    nivelRiesgo: "alto",
    puntajeRiesgo: 78,
    categoria: "Energía",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Etiquetado energético", "Registro MINEM", "Certificación de eficiencia"],
    areasImpacto: ["Diseño de producto", "Importación", "Marketing"],
    resumenIA: {
      queCambia: "Etiquetado energético obligatorio A-G. Estándares mínimos de rendimiento. Registro en MINEM.",
      afectados: "Todos los importadores de electrodomésticos. Hervidores y cafeteras incluidos.",
      fechaClave: `Vigente desde ${diasAtras(22)}. Cumplimiento total en 365 días.`,
      explicacionRiesgo: "Alto impacto operativo. Requiere certificación de eficiencia y rediseño de etiquetado.",
      actoresClave: ["MINEM", "OSINERGMIN", "Laboratorios de ensayo"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-ds-018-2024-minem"
  },
  {
    id: "pe-rm-156-2024-minsa",
    identificador: "Resolución Ministerial N° 156-2024/MINSA",
    titulo: "Actualización del Reglamento Sanitario de Alimentos - Equipos de Preparación",
    resumen: "Actualiza requisitos sanitarios para equipos de preparación de alimentos y bebidas.",
    puntosClave: [
      "Nuevos límites de migración para materiales en contacto con agua caliente",
      "Certificación sanitaria obligatoria",
      "Trazabilidad de componentes alimentarios"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "resolucion-ministerial",
    esVinculante: true,
    autoridadEmisora: "MINSA - Ministerio de Salud",
    autoridadFiscalizadora: "DIGESA",
    autoridadesCompetentes: ["MINSA", "DIGESA"],
    estado: "en-tramite",
    estadoGenerico: "pipeline",
    indiceEtapaActual: 2,
    fechaPublicacion: diasAtras(28),
    fuentePublicacion: "El Peruano",
    fechaLimiteCumplimiento: diasAdelante(180),
    nivelRiesgo: "alto",
    puntajeRiesgo: 82,
    categoria: "Materiales en Contacto con Alimentos",
    sector: "Electrodomésticos de Cocina",
    obligacionesAfectadas: ["Certificación DIGESA", "Pruebas de migración", "Trazabilidad"],
    areasImpacto: ["Calidad", "Proveedores", "Importación"],
    resumenIA: {
      queCambia: "Nuevos límites de migración para hervidores y cafeteras. Certificación DIGESA obligatoria.",
      afectados: "Fabricantes e importadores de electrodomésticos que entran en contacto con alimentos/bebidas.",
      fechaClave: `Proyecto publicado ${diasAtras(28)}. Cumplimiento en 180 días post-aprobación.`,
      explicacionRiesgo: "Alto riesgo regulatorio. DIGESA puede decomisar productos sin certificación.",
      actoresClave: ["MINSA", "DIGESA", "Laboratorios acreditados"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-rm-156-2024-minsa"
  },
  // Items 31-60 days ago
  {
    id: "pe-om-1892-2024-mdsjl",
    identificador: "Ordenanza Municipal N° 1892-MDSJL",
    titulo: "Regulación de Comercio Electrónico de Electrodomésticos en San Juan de Lurigancho",
    resumen: "Regula la venta electrónica de electrodomésticos en el distrito de San Juan de Lurigancho.",
    puntosClave: [
      "Registro de vendedores de electrodomésticos en línea",
      "Garantía mínima de 1 año obligatoria",
      "Información de seguridad visible en publicaciones"
    ],
    pais: "PE",
    nivel: "municipal",
    departamento: "LIM",
    ...
    tipoNorma: "ordenanza-municipal",
    esVinculante: true,
    autoridadEmisora: "Municipalidad Distrital de San Juan de Lurigancho",
    autoridadFiscalizadora: "MDSJL - Gerencia de Fiscalización",
    autoridadesCompetentes: ["MDSJL"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(38),
    fuentePublicacion: "El Peruano (Normas Municipales)",
    fechaEntradaVigencia: diasAtras(38),
    nivelRiesgo: "bajo",
    puntajeRiesgo: 35,
    categoria: "Protección al Consumidor",
    sector: "Retail",
    obligacionesAfectadas: ["Registro municipal", "Garantías", "Información de seguridad"],
    areasImpacto: ["E-commerce", "Servicio al cliente"],
    resumenIA: {
      queCambia: "Requisitos locales para venta online de electrodomésticos en SJL. Registro y garantías obligatorias.",
      afectados: "Vendedores online con entregas en San Juan de Lurigancho.",
      fechaClave: `Vigente desde ${diasAtras(38)}. Cumplimiento inmediato.`,
      explicacionRiesgo: "Bajo impacto - aplica solo a distrito específico.",
      actoresClave: ["MDSJL"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-om-1892-mdsjl"
  },
  {
    id: "pe-ds-022-2024-minam",
    identificador: "Decreto Supremo N° 022-2024-MINAM",
    titulo: "Reglamento de Gestión de Pilas y Baterías Usadas",
    resumen: "Establece el régimen de responsabilidad extendida del productor para pilas y baterías.",
    puntosClave: [
      "Sistema de recolección obligatorio",
      "Metas de recuperación: 25% (2025), 40% (2027)",
    ...
    esVinculante: true,
    autoridadEmisora: "MINAM - Ministerio del Ambiente",
    autoridadFiscalizadora: "OEFA",
    autoridadesCompetentes: ["MINAM", "OEFA"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(45),
    ...
    puntajeRiesgo: 80,
    categoria: "Medio Ambiente",
    sector: "Electrodomésticos Portátiles",
    obligacionesAfectadas: ["Sistema de recolección", "Metas de recuperación", "Etiquetado"],
    areasImpacto: ["Logística inversa", "Packaging", "Costos operativos"],
    resumenIA: {
      queCambia: "REP obligatorio para pilas/baterías. Sistema de recolección y metas de recuperación progresivas.",
      afectados: "Importadores de electrodomésticos con baterías (hervidores inalámbricos, cafeteras portátiles).",
      fechaClave: `Vigente desde ${diasAtras(45)}. Meta 25% para 2025.`,
      explicacionRiesgo: "Alto impacto financiero y operativo por implementación de logística inversa.",
      actoresClave: ["MINAM", "OEFA", "Operadores de residuos autorizados"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-ds-022-2024-minam"
  },
  {
    id: "pe-or-312-2024-gra",
    identificador: "Ordenanza Regional N° 312-2024-GRA/CR",
    titulo: "Fomento de Energías Renovables en Arequipa",
    resumen: "Incentivos para empresas que utilicen energías renovables en procesos productivos.",
    puntosClave: [
      "Reducción de 15% en canon minero por uso de renovables",
      "Certificación verde regional",
      "Preferencia en compras públicas regionales"
    ],
    pais: "PE",
    nivel: "regional",
    departamento: "ARE",
    ...
    esVinculante: true,
    autoridadEmisora: "Gobierno Regional de Arequipa",
    autoridadFiscalizadora: "GRA - Gerencia de Desarrollo Económico",
    autoridadesCompetentes: ["GRA"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(52),
    fuentePublicacion: "El Peruano (Normas Regionales)",
    fechaEntradaVigencia: diasAtras(52),
    nivelRiesgo: "bajo",
    puntajeRiesgo: 28,
    categoria: "Energía",
    sector: "Manufactura",
    obligacionesAfectadas: ["Certificación voluntaria", "Reporte de consumo energético"],
    areasImpacto: ["Operaciones en Arequipa", "Sostenibilidad"],
    resumenIA: {
      queCambia: "Incentivos para uso de renovables en Arequipa. Certificación verde y beneficios tributarios.",
      afectados: "Empresas con operaciones en Arequipa. Oportunidad de reducción de costos.",
      fechaClave: `Vigente desde ${diasAtras(52)}. Beneficios aplicables desde solicitud.`,
      explicacionRiesgo: "Bajo riesgo - oportunidad de beneficio, no obligación.",
      actoresClave: ["GRA", "OSINERGMIN"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-or-312-2024-gra"
  },
  // Items 61-90 days ago
  {
    id: "pe-rm-234-2024-produce",
    identificador: "Resolución Ministerial N° 234-2024-PRODUCE",
    titulo: "Estándares de Calidad para Electrodomésticos Importados",
    resumen: "Establece requisitos de calidad para electrodomésticos importados al mercado peruano.",
    puntosClave: [
      "Certificación de calidad de país de origen",
      "Inspección aleatoria en aduanas",
    ...
    tipoNorma: "resolucion-ministerial",
    esVinculante: true,
    autoridadEmisora: "PRODUCE",
    autoridadFiscalizadora: "PRODUCE en coordinación con SUNAT",
    autoridadesCompetentes: ["PRODUCE", "SUNAT"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(65),
    fuentePublicacion: "El Peruano",
    fechaEntradaVigencia: diasAtras(65),
    nivelRiesgo: "medio",
    puntajeRiesgo: 62,
    categoria: "Protección al Consumidor",
    sector: "Importaciones",
    obligacionesAfectadas: ["Certificación de origen", "Documentación técnica", "Inspección"],
    areasImpacto: ["Importación", "Documentación", "Logística"],
    resumenIA: {
      queCambia: "Requisitos de certificación para importaciones. Documentación técnica obligatoria en español.",
      afectados: "Todos los importadores de electrodomésticos.",
      fechaClave: `Vigente desde ${diasAtras(65)}. Cumplimiento inmediato en nuevas importaciones.`,
      explicacionRiesgo: "Medio impacto - principalmente documental.",
      actoresClave: ["PRODUCE", "SUNAT", "Agentes de aduana"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-rm-234-2024-produce"
  },
  {
    id: "pe-dl-1578-2024",
    identificador: "Decreto Legislativo N° 1578",
    titulo: "Ley de Promoción del Comercio Justo de Electrodomésticos",
    resumen: "Promueve prácticas comerciales justas en la venta de electrodomésticos.",
    puntosClave: [
      "Prohibición de cláusulas abusivas en garantías",
      "Derecho de retracto de 7 días",
      "Publicidad veraz obligatoria"
    ],
    pais: "PE",
    nivel: "nacional",
    tipoNorma: "decreto-legislativo",
    esVinculante: true,
    autoridadEmisora: "Poder Ejecutivo",
    autoridadFiscalizadora: "INDECOPI",
    autoridadesCompetentes: ["INDECOPI", "PCM"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(72),
    fuentePublicacion: "El Peruano",
    fechaEntradaVigencia: diasAtras(42),
    nivelRiesgo: "medio",
    puntajeRiesgo: 68,
    categoria: "Protección al Consumidor",
    sector: "Comercio",
    obligacionesAfectadas: ["Garantías", "Devoluciones", "Publicidad"],
    areasImpacto: ["Ventas", "Marketing", "Legal"],
    resumenIA: {
      queCambia: "Derecho de retracto 7 días. Prohibición de cláusulas abusivas. Publicidad veraz.",
      afectados: "Todos los comercializadores de electrodomésticos.",
      fechaClave: `Vigente desde ${diasAtras(42)}. Cumplimiento obligatorio.`,
      explicacionRiesgo: "Medio impacto - ajustes en políticas de venta y garantías.",
      actoresClave: ["INDECOPI", "Asociaciones de consumidores"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-dl-1578-2024"
  },
  {
    id: "pe-ntp-370-105-2024",
    identificador: "NTP 370.105:2024",
    titulo: "Eficiencia Energética - Hervidores Eléctricos",
    resumen: "Norma técnica para medición y clasificación de eficiencia energética en hervidores eléctricos.",
    puntosClave: [
      "Metodología de ensayo de eficiencia",
      "Clasificación A-G para hervidores",
    ...
    tipoNorma: "ntp",
    esVinculante: false,
    autoridadEmisora: "INACAL",
    autoridadFiscalizadora: "N/A",
    autoridadesCompetentes: ["INACAL"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(78),
    fuentePublicacion: "Catálogo INACAL",
    fechaEntradaVigencia: diasAtras(78),
    nivelRiesgo: "bajo",
    puntajeRiesgo: 45,
    categoria: "Energía",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Cumplimiento voluntario"],
    areasImpacto: ["Diseño", "Marketing"],
    resumenIA: {
      queCambia: "Metodología de clasificación energética A-G para hervidores. Base para etiquetado.",
      afectados: "Fabricantes de hervidores. Cumplimiento voluntario.",
      fechaClave: `Vigente desde ${diasAtras(78)}. De aplicación voluntaria.`,
      calificadorVoluntariedad: "De aplicación voluntaria salvo referencia en reglamento técnico.",
      explicacionRiesgo: "Bajo riesgo - norma voluntaria pero útil para diferenciación.",
      actoresClave: ["INACAL"]
    },
    linkFuente: "https://catalogo.inacal.gob.pe/placeholder-ntp-370-105"
  },
  {
    id: "pe-om-567-2024-mda",
    identificador: "Ordenanza Municipal N° 567-MDA",
    titulo: "Control de Ruido de Electrodomésticos en Zona Residencial de Ate",
    resumen: "Establece límites de ruido para electrodomésticos en zonas residenciales del distrito de Ate.",
    puntosClave: [
      "Límite de 55 dB durante el día",
      "Límite de 45 dB durante la noche",
      "Sanciones por molestias reiteradas"
    ],
    pais: "PE",
    nivel: "municipal",
    departamento: "LIM",
    ...
    tipoNorma: "ordenanza-municipal",
    esVinculante: true,
    autoridadEmisora: "Municipalidad Distrital de Ate",
    autoridadFiscalizadora: "MDA - Gerencia de Fiscalización",
    autoridadesCompetentes: ["MDA"],
    estado: "vigente",
    estadoGenerico: "vigente",
    indiceEtapaActual: 4,
    fechaPublicacion: diasAtras(85),
    fuentePublicacion: "El Peruano (Normas Municipales)",
    fechaEntradaVigencia: diasAtras(85),
    nivelRiesgo: "bajo",
    puntajeRiesgo: 32,
    categoria: "Medio Ambiente",
    sector: "Electrodomésticos",
    obligacionesAfectadas: ["Límites de ruido"],
    areasImpacto: ["Diseño de producto"],
    resumenIA: {
      queCambia: "Límites de ruido para electrodomésticos en Ate. 55 dB día / 45 dB noche.",
      afectados: "Fabricantes de electrodomésticos ruidosos vendidos en Ate.",
      fechaClave: `Vigente desde ${diasAtras(85)}. Aplica a nuevas instalaciones.`,
      explicacionRiesgo: "Bajo impacto - límites razonables, aplica a distrito específico.",
      actoresClave: ["MDA"]
    },
    linkFuente: "https://busquedas.elperuano.pe/placeholder-om-567-mda"
  }
];
