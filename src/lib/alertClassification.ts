...
export const ZONE_META: Record<CardZone, ZoneMeta> = {
  action: {
    ...
    hint: "Alertas con impacto o urgencia igual o superior a 70.",
    dot: "bg-destructive",
  ...
  monitor: {
    id: "monitor",
    label: "Monitorear",
    hint: "Impacto entre 40 y 69 y no clasificada como acción requerida.",
  ...
  low: {
    id: "low",
    label: "Bajo impacto",
    hint: "Impacto menor a 40 y urgencia menor a 70. Sin prioridad inmediata.",
