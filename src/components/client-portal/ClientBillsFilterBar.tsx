...
export interface ClientBillsFilters {
  search: string;
  areas: string[];
  stages: string[];
  sectors: string[];
...
interface ClientBillsFilterBarProps {
  filters: ClientBillsFilters;
  onFiltersChange: (filters: ClientBillsFilters) => void;
...
export function ClientBillsFilterBar({ 
  filters, 
  onFiltersChange, 
