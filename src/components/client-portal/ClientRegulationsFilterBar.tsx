...
export interface ClientRegulationsFilters {
  search: string;
  areas: string[];
  entities: string[];
  sectors: string[];
...
interface ClientRegulationsFilterBarProps {
  filters: ClientRegulationsFilters;
  onFiltersChange: (filters: ClientRegulationsFilters) => void;
...
export function ClientRegulationsFilterBar({ 
  filters, 
  onFiltersChange, 
  availableEntities,
  availableSectors,
  ...
  totalCount,
  filteredCount
}: ClientRegulationsFilterBarProps) {
