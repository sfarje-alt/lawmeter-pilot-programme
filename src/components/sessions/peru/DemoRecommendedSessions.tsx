...
const demoRecommendedSessions: DemoRecommendedSession[] = [
  {
    ...
    date: 'Friday, December 27, 2025, 10:00',
    videoStatus: 'pending',
    hasAgenda: true,
  },
  {
    ...
    date: 'Thursday, December 26, 2025, 15:00',
    videoStatus: 'pending',
    hasAgenda: true,
  },
  {
    id: 'rec-3',
    commission: 'CIENCIA, INNOVACIÓN Y TECNOLOGÍA',
    date: 'Wednesday, December 25, 2025, 09:30',
    videoStatus: 'found',
    hasAgenda: false,
  },
  {
    id: 'rec-4',
    commission: 'SALUD Y POBLACIÓN',
    date: 'Tuesday, December 24, 2025, 11:00',
    videoStatus: 'found',
    hasAgenda: true,
  },
  {
    id: 'rec-5',
    commission: 'CIENCIA, INNOVACIÓN Y TECNOLOGÍA',
    date: 'Monday, December 23, 2025, 14:30',
    videoStatus: 'found',
    hasAgenda: true,
  },
];
