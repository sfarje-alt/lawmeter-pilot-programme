...
const styles = StyleSheet.create({
  ...
  snapshotBlock: { marginBottom: 10, borderWidth: 1, borderColor: COLORS.border, borderRadius: 6, padding: 12 },
  snapshotBlockAlert: { marginBottom: 10, borderWidth: 1, borderColor: "#fecaca", borderRadius: 6, padding: 12, backgroundColor: "#fef2f2" },
  snapshotKicker: { fontSize: 7.5, fontFamily: "Helvetica-Bold", color: COLORS.brandLine, letterSpacing: 1.2, marginBottom: 6 },
  snapshotKickerRed: { fontSize: 7.5, fontFamily: "Helvetica-Bold", color: "#991b1b", letterSpacing: 1.2, marginBottom: 6 },
